...
/** Ficha de producto. La comparten /catalogo/[slug] y /tienda/[slug]. */
export async function ProductDetailView({ slug, canal, backLabel }: Props) {
  const product = await getProductBySlug(slug, canal);
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <AddToCartButton product={product} canal={canal} />
          </div>
        </div>
      </main>
      <Footer />
